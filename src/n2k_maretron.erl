...
-define(TLM_100_PROD_CODE, 16#6C4D).
-define(TLM_100_SW_CODE, 16#1).

-define(SSC300_PROD_CODE, 16#1B2).
-define(SSC300_SW_CODE, 16#1).
...
recv_nmea_acknowledge_group_function(Tr) ->
    n2k_transport:recv(
        Tr, {message, [126208]}, fun recv_nmea_acknowledge_group_function_handler/2, []
    ).
